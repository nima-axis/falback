...
// ══════════════════════════════════════════════════════════════
//  RUNTIME PROXY — serves bot entry to client launcher
//  Client fetches this; actual source stays in private GitHub
// ══════════════════════════════════════════════════════════════
...
// Returns signed download URL (client fetches content from here)
app.get('/api/runtime/meta', async (req, res) => {
  // Basic check — only serve to verified premium bots
  // (In production, add token-based auth per bot here)
  const rawUrl = `https://raw.githubusercontent.com/${GITHUB_REPO}/${GITHUB_BRANCH}/${GITHUB_ENTRY}`;
  
  // Proxy the content directly (GitHub token kept server-side only)
  try {
